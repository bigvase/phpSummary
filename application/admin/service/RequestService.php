...
class RequestService
{
    ...
    public static function request()
    {
        ...
        if ($req === false) {
            ...
            $req = new RequestService($_config);
        }
        return $req;
    }
    ...
    private function debug($url, $postStr, $requestHeader, $result)
    {
        ...
        if (ESIGN_DEBUGE ) {
            ...
            $str .= PHP_EOL . '【请求参数】：' . (is_array($postStr) ? $this->jsonEncode($postStr) : $postStr);
     ...
     */
    public function buildRequestSign($query)
    {
